        ...
        <div className="bg-box-pattern pt-5 xl:pt-[90px]" id="about">
            <div className="container">
                <div className="flex justify-center">
                    <div className="max-w-[1140px] w-full p-5 lg:px-0 lg:py-[54.5px] rounded-3xl xl:rounded-[32px] border-[4px] border-white bg-[linear-gradient(133.83deg,#00B9FF_3.77%,#6F69F2_81.07%)]" data-aos="zoom-in">
