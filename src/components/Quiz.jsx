    ...
    return (
        /////////////////// Quiz 6th section //////////////////////////////
            <div className=" container  max-w-[540px] md:max-w-[920px] lg:max-w-[992px] xl:max-w-[1200px] 2xl:max-w-[1164px]">
                <div className="row py-[50px] xl:py-[70px]" id="pricing">
                    <div className="col-12 lg:col-6 flex flex-col lg:justify-end items-center lg:items-start mt-3 lg:mt-0" data-aos="fade-down">
                        <div className="max-lg:max-w-4xl">
                            <div className="relative">
                                ...
                                <p className='font-graph-semi text-2xxl bg-[linear-gradient(180deg,#6F69F2_0%,#403d8c00_100%)] inline-block text-transparent bg-clip-text absolute top-[-82%] opacity-20'>05</p>
                            </div>
