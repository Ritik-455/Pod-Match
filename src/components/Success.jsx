            ...
            <div className="row lg:py-[35px] xl:py-[72px]" id="features">
                ...
                <div className="col-12 lg:col-6 flex flex-col lg:justify-end items-center lg:items-start mt-3 lg:mt-0" data-aos="fade-down">
                    <div className="relative">
                        ...
                        <p className='font-graph-semi text-2xxl bg-[linear-gradient(180deg,#6F69F2_0%,#403d8c00_100%)] hidden lg:inline-block text-transparent bg-clip-text absolute top-[-100%] opacity-10'>02</p>
                    </div>
