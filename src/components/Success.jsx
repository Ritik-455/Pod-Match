...
const Success = () => {
    return (
        /////////////////// Success 3rd section //////////////////////////////
            <div className="row py-[50px] xl:py-[72px] flex-col-reverse lg:flex-row" id="features">
                <div className="col-12 lg:col-6 flex justify-center mt-6" data-aos="fade-up">
                    <img src={Avatar} alt="Avatar" width={508} height={346} className=' max-w-4xl w-full shadow-3xl' />
                </div>
                <div className="col-12 lg:col-6 flex flex-col lg:justify-end items-center lg:items-start mt-3 lg:mt-0" data-aos="fade-down">
                    <div className="max-lg:max-w-4xl">
                        <div className="relative">
                            ...
                            <p className='font-graph-semi text-2xxl bg-[linear-gradient(180deg,#6F69F2_0%,#403d8c00_100%)] inline-block text-transparent bg-clip-text absolute top-[-100%] opacity-20'>02</p>
                        </div>
